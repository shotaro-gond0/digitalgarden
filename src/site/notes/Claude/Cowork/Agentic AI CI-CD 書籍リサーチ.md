---
{"dg-publish":true,"permalink":"/claude/cowork/agentic-ai-ci-cd/","tags":["cat/ml-dl","cat/python","cat/devops","cat/claude","cat/agentic-ai"],"dg-note-properties":{"tags":["cat/ml-dl","cat/python","cat/devops","cat/claude","cat/agentic-ai"]}}
---
